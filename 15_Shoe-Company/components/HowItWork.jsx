    ...
    return(
        <section id="how-it-work" className="section-container pt-22">
            ...
            <div className="max-w-2xl mx-auto pt-72 xl:pt-12 relative">
                <img className="w-full max-w-2xl rotate-6 p-8 @min-[440px]:p-0 xl:rotate-0" src="../src/assets/jutti2.png" alt="second shoe"/>
                <div className="max-w-[200px] xl:max-w-xs absolute -top-12 xl:-translate-x-full">
                    ...
                    <img className="w-32 xl:ml-auto rotate-45 xl:rotate-0 translate-y-10" src="../src/assets/arrow-1.png" alt="arrow 1"/>
                </div>
                <div className="max-w-[200px] xl:max-w-xs absolute top-16 @min-[560px]:top-0 right-0 xl:-right-62">
                    <img className="w-32 @min-[560px]:w-auto xl:-ml-26 translate-y-full @min-[560px]:translate-y-60 rotate-[120deg] xl:rotate-0 xl:translate-y-0" src="../src/assets/arrow-2.png" alt="arrow 2"/>
                    <div className="ml-10">
                ...
                <div className="max-w-[200px] xl:max-w-xs absolute -bottom-10">
                    <img className="ml-auto -mb-14 max-w-[150px] pb-6" src="../src/assets/arrow-3.png" alt="arrow 3"/>
