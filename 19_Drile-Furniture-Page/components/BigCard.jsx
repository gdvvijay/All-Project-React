...
export default function BigCard({
  ...
  discountValue
    ...
    return(
        <div className={`${className} flex flex-col items-center shadow-[0_0_1px_1px_rgba(0,0,0,10%)] max-w-[350px] max-h-[342px] relative mr-auto`}>
        {isHot ? (
        ...
        {isDiscount ? (
          <p className="absolute top-8 right-1 bg-[#9E0B0F] px-[1.09375rem] text-[#ffffff] font-sans">
            {discountValue}
          </p>
        ) : (
          ""
